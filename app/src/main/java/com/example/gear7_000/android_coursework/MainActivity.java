                ...
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (position == 0) {
                            ...
                            intentDisplay.setAction("com.example.gear7_000.android_coursework.BuildingDisplayInfo");
                            intentDisplay.putExtra(INFO_ONE, "Building Information:\n\nThis is the location of our Coventry University College which opened in 2012, offering a new concept in HE, designed to integrate study into your life. The building was built in the 1970’s and is named after the Coventry based engineering group  that operated during the first half of the 20th Century. They were renowned for the design and build of cars, aero-engines and aircraft and were absorbed into Rolls-Royce in 1966.");
                        } else if (position == 3) {
                            intentDisplay.setAction("com.example.gear7_000.android_coursework.BuildingDisplayInfo");
                            ...
                            intentDisplay.setAction("com.example.gear7_000.android_coursework.BuildingDisplayInfo");
                            intentDisplay.putExtra(INFO_ONE, "Building Information:\n\nThis building was built in 1960 and is used solely by our Faculty of Business and Law. George Eliot is the pen name of the novelist Mary Anne Evans (1819-1880) and was one of the leading writers of the Victorian era.");
                        } else if (position == 9) {
                            intentDisplay.setAction("com.example.gear7_000.android_coursework.BuildingDisplayInfo");
                            intentDisplay.putExtra(INFO_ONE, "Building Information:\n\nBuilt in 1959, this building is used by our Faculty of Arts and Humanities, predominately for the Design and Visual Art students, fitted with a full commercial fashion studio. This building was aptly named after the painter and print maker who created the world famous tapestry Christ in Glory hanging in Coventry Cathedral.");
                        } else if (position == 10) {
                            intentDisplay.setAction("com.example.gear7_000.android_coursework.BuildingDisplayInfo");
                            ...
                            intentDisplay.setAction("com.example.gear7_000.android_coursework.BuildingDisplayInfo");
                            intentDisplay.putExtra(INFO_ONE, "Building Information:\n\nThis building was built in the late 1970’s and sponsored by the Coventry based car manufacturer. It has recently undergone a significant refurbishment, with additional improvements planned.  It is now home to our Postgraduate students, as well as our researchers within the Centre for Business in Society (CBiS). ");
                        } else if (position == 12) {
                            intentDisplay.setAction("com.example.gear7_000.android_coursework.BuildingDisplayInfo");
                            intentDisplay.putExtra(INFO_ONE, "Building Information:\n\nBuilt in the late 1950’s, this is home to our Faculty of Health and Life Sciences. It was named after the British inventor of the Coventry tricycle and father of the bicycle industry.");
                        } else if (position == 13) {
                            intentDisplay.setAction("com.example.gear7_000.android_coursework.BuildingDisplayInfo");
                            intentDisplay.putExtra(INFO_ONE, "Building Information:\n\nBuilt in 1978, this building is used by our Faculty of Arts and Humanities, who mainly run their Industrial Design courses from here. The building has been named after the former Deputy Director of Coventry Polytechnic and one of the University’s Honorary Life Fellows.");
                        } else if (position == 14) {
                            intentDisplay.setAction("com.example.gear7_000.android_coursework.BuildingDisplayInfo");
                            ...
                            intentDisplay.setAction("com.example.gear7_000.android_coursework.BuildingDisplayInfo");
                            intentDisplay.putExtra(INFO_ONE, "Building Information:\n\nThis building was built in 1970, and was named after the knighted British entrepreneur in the construction industry. This building is primarily used by the Faculty of Engineering, Environment and Computing, offering courses relating to the construction industry.");
                        } else if (position == 18) {
                            intentDisplay.setAction("com.example.gear7_000.android_coursework.BuildingDisplayInfo");
                            intentDisplay.putExtra(INFO_ONE, "Building Information:\n\nConstructed in1980, this building is home to our IT services. Sir William Lyons was the co-founder of the Swallow Sidecar Company which subsequently became Jaguar Cars Limited.");
                        } else if (position == 19) {
                            intentDisplay.setAction("com.example.gear7_000.android_coursework.BuildingDisplayInfo");
                            intentDisplay.putExtra(INFO_ONE, "Building Information:\n\nConstruction was completed in 2006, and as its name suggests is home to some key student services as well as our International Office. This is where our students enroll as well as the main information point for student accommodation and finance queries.");
                        } else if (position == 20) {
                            intentDisplay.setAction("com.example.gear7_000.android_coursework.BuildingDisplayInfo");
                            intentDisplay.putExtra(INFO_ONE, "Building Information:\n\nThis is a small office used by our Faculty of Health and Life Sciences. Built in 1922 and its name is drawn from the Carmelite Friary founded in 1342 in Coventry.");
                        } else if (position == 21) {
                            intentDisplay.setAction("com.example.gear7_000.android_coursework.BuildingDisplayInfo");
